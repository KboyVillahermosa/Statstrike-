  ...
  <div class="flex h-screen bg-black overflow-hidden">
    ...
    >
      ...
      <div class="p-6 border-b border-gray-900/50">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <span class="text-xs text-orange-400 font-semibold">Admin Panel</span>
          </div>
        </div>
      </div>
      ...
      <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        <NavLink href="/admin/dashboard" :active="isActive('/admin/dashboard')" icon="dashboard">
          Dashboard
        </NavLink>
        <NavLink href="/admin/users" :active="isActive('/admin/users')" icon="users">
          Users
        </NavLink>
        <NavLink href="/admin/challenges" :active="isActive('/admin/challenges')" icon="trophy">
          Challenges
        </NavLink>
        <NavLink href="/admin/community/posts" :active="isActive('/admin/community')" icon="community">
          Community Posts
        </NavLink>
      </nav>
...
const isActive = (href) => {
  ...
  if (href === '/admin/challenges') {
    return url.startsWith('/admin/challenges');
  }
  if (href === '/admin/community') {
    return url.startsWith('/admin/community');
  }
  if (href === '/admin/users') {
