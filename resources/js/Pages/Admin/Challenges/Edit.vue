...
const form = useForm({
    ...
    target_count: props.challenge.target_count,
    target_unit: props.challenge.target_unit,
    duration_days: props.challenge.duration_days,
    is_active: props.challenge.is_active,
    starts_at: props.challenge.starts_at ? new Date(props.challenge.starts_at).toISOString().slice(0, 16) : '',
    ends_at: props.challenge.ends_at ? new Date(props.challenge.ends_at).toISOString().slice(0, 16) : '',
    image_url: props.challenge.image_url || '',
});
...
<template>
    <Head :title="`Edit Challenge: ${challenge.title}`" />
        ...
        <div>
            ...
            <div class="mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-4xl md:text-5xl font-bold text-white mb-3">Edit Challenge</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex gap-3 pt-4">
                        <PrimaryButton :disabled="form.processing">
                            {{ form.processing ? 'Updating...' : 'Update Challenge' }}
                        </PrimaryButton>
                        <Link
                            :href="route('admin.challenges.show', challenge.id)"
